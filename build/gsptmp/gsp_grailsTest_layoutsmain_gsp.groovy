...
class gsp_grailsTest_layoutsmain_gsp extends org.grails.gsp.GroovyPage {
...
printHtmlPart(6)
invokeTag('message','g',43,['code':("spinner.alt"),'default':("Loading&hellip;")],-1)
printHtmlPart(7)
invokeTag('javascript','asset',46,['src':("application.js")],-1)
printHtmlPart(8)
})
